...
return ( 
  ...
  <Container>
    <>
  {cart.cartItems.length===0? (<div> You didn't add your favorite bascket yet <NavLink to="/products"> Go back</NavLink></div>):(
    cart.cartItems.map((item)=>(
      ...
      <Button variant="success" onClick={handleShow} style={{marginBottom:10}}>Reserve</Button>
